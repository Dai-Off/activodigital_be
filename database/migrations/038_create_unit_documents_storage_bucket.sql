-- ============================================================================
-- Migración: Crear bucket de Storage para documentos de unidades
-- ============================================================================
-- Este script crea el bucket en Supabase Storage para documentos de unidades
...
-- 1. Crear el bucket para documentos de unidades
...
CREATE POLICY "Authenticated users can view unit documents"
...
CREATE POLICY "Authenticated users can update unit documents"
