...
try {
    (0, dataRoomProcessingQueue_1.startDataRoomProcessingWorker)();
}
catch (e) {
    console.warn("[DataRoomQueue] No se pudo iniciar el worker de Data Room (¿Redis configurado? REDIS_URL):", e.message);
}
// Iniciar el servidor
server.listen(port, () => {
    // eslint-disable-next-line no-console
