...
class InsuranceService {
     ...
     */
    async getBuildingInsurances(buildingId, filters = {}) {
        ...
        if (error) {
            throw new Error(`Error al obtener seguros del edificio: ${error.message}`);
        }
        return data.map((item) => this.mapToInsurance(item));
    }
    // ==========================================
    ...
    async updateInsurance(id, data) {
        ...
        if (data.insurer !== undefined)
            updateData.insurer = data.insurer;
