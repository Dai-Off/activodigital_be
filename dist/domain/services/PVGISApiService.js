...
exports.PVGISApiService = void 0;
class PVGISApiService {
     ...
     */
    async GetBuildingPVEnergyOutput(lat, lon, peakpower, loss, mountingplace = "building") {
        try {
     ...
     */
    async GetDetailedHourlyData(lat, lon, pvcalculation, peakpower, loss) {
        try {
     ...
     * @param lon Longitud.
     */
    async GetTypicalMeteorologicalYear(lat, lon) {
        try {
     ...
     */
    async GetMonthlyRadiation(lat, lon, horirrad, optrad) {
        try {
...
exports.PVGISApiService = PVGISApiService;
//# sourceMappingURL=PVGISApiService.js.map