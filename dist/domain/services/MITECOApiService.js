...
exports.MitecoApiService = void 0;
class MitecoApiService {
    constructor() {
     ...
     */
    async GetPackageList(limit, offset) {
        try {
     ...
     */
    async SearchPackages(q, rows, fq) {
        try {
     ...
     */
    async GetOrganizationList(all_fields) {
        try {
     ...
     */
    async GetTagList(vocabulary_id) {
        try {
     ...
     */
    async SearchDataStore(resource_id, limit) {
        try {
     ...
     * @param rows (Opcional) Número máximo de resultados a devolver.
     */
    async SearchPackagesByOrganization(orgId, q, rows) {
     ...
     * @param rows (Opcional) Número máximo de resultados a devolver.
     */
    async SearchPackagesByTag(tag, q, rows) {
        // Lógica delegada a SearchPackages con el filtro fq
...
exports.MitecoApiService = MitecoApiService;
//# sourceMappingURL=MITECOApiService.js.map