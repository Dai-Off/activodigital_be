    ...
    constructor() {
        ...
        this.createSimpleSession = async (req, res) => {
            try {
                ...
                TrazabilityService_1.trazabilityService
                    .registerTrazability({
                    authUserId: userId,
                    buildingId,
                    action: interfaceTrazability_1.ActionsValues["CREAR"],
                    module: interfaceTrazability_1.ModuleValues.DOCUMENTOS,
        ...
        this.updateSession = async (req, res) => {
            try {
                ...
                TrazabilityService_1.trazabilityService
                    ...
                    action: interfaceTrazability_1.ActionsValues["CARGA"],
                    module: interfaceTrazability_1.ModuleValues.CERTIFICADOS,
        ...
        this.confirmCertificate = async (req, res) => {
            try {
                ...
                TrazabilityService_1.trazabilityService
                    ...
                    action: interfaceTrazability_1.ActionsValues["APROBAR"],
                    module: interfaceTrazability_1.ModuleValues.DOCUMENTOS,
                    description: "Creo sesión de Certificado energético",
                })
                    .catch((err) => console.error("Fallo trazabilidad:", err));
        ...
        this.deleteSession = async (req, res) => {
            try {
                ...
                TrazabilityService_1.trazabilityService
                    ...
                    action: interfaceTrazability_1.ActionsValues["ELIMINAR"],
                    module: interfaceTrazability_1.ModuleValues.DOCUMENTOS,
         ...
         */
        this.updateCertificate = async (req, res) => {
            try {
                const userId = req.user?.id;
                if (!userId) {
                    res.status(401).json({ error: "Usuario no autenticado" });
                ...
                const data = req.body;
                const certificate = await this.getCertificateService().updateEnergyCertificate(certificateId, data, userId);
                TrazabilityService_1.trazabilityService
                    .registerTrazability({
                    authUserId: userId,
                    buildingId: certificate?.buildingId,
                    action: interfaceTrazability_1.ActionsValues["ACTUALIZAR O MODIFICAR DOCUMENTOS"],
                    module: interfaceTrazability_1.ModuleValues.CERTIFICADOS,
        ...
        this.processAIData = async (req, res) => {
            try {
                ...
                TrazabilityService_1.trazabilityService
                    ...
                    authUserId: userId,
                    buildingId: session?.buildingId,
                    action: interfaceTrazability_1.ActionsValues["GENERAR INFORMES"],
                    module: interfaceTrazability_1.ModuleValues.DOCUMENTOS,
